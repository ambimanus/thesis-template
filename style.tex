...
% Symbols
%
% Here the tooltip must be ASCII, otherwise the compiler would break when using
% a symbol in math mode. Therefore, a few extra arguments are necessary.
% Also, we want to be able to assign an index to the symbols. Thus the command
% definition below is a lot more difficult.
\makeatletter
\newcommand{\mksym}[4]{%
  ...
  %
  % Second, define the tooltip text based on argument #3.
  \global\expandafter\def\csname @tt#1\endcsname{#3}%
  %
  % Third, build the actual delegate targets (hyperref package required)
  \global\expandafter\def\csname @@#1\endcsname[##1]{%
    \href{Definition: \csname @tt#1\endcsname}{%
      \textcolor{black}{\ensuremath{#2_{##1}}}%
    }%
  }%
...
\mksym{skommunikationsnetz}{\mathsfit{C}}{Kommunikationsnetz}{11c}
\mksym{soverlayedges}{\mathsfit{E}}{Kantenmenge}{11e}
\mksym{sfitglobal}{f}{Globale Gütefunktion}{11f}
%
...
\mksym{skonfkeys}{\mathsfit{K}}{Schlüsselmenge einer Konfiguration}{12kappa1}
\mksym{sfplzaehler}{\lambda}{Fahrplan-Zähler}{12lambda}
\mksym{smsg}{\mu}{Nachricht}{12mu}
%
% Symbols: Chapter 2
% \nomenclature[S20]{}{}
